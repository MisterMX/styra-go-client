...
// SystemsV1SystemsComplianceRequest systems v1 systems compliance request
//
// swagger:model systems.v1.SystemsComplianceRequest
type SystemsV1SystemsComplianceRequest struct {
	...
	GroupBy []SystemsV1SystemsComplianceRequestGroupBy `json:"group_by"`
...
// Validate validates this systems v1 systems compliance request
func (m *SystemsV1SystemsComplianceRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SystemsV1SystemsComplianceRequest) validateGroupBy(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsComplianceRequest) validateMocks(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsComplianceRequest) validateSort(formats strfmt.Registry) error {
...
// ContextValidate validate this systems v1 systems compliance request based on the context it is used
func (m *SystemsV1SystemsComplianceRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SystemsV1SystemsComplianceRequest) contextValidateGroupBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsComplianceRequest) contextValidateMocks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsComplianceRequest) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsComplianceRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SystemsV1SystemsComplianceRequest) UnmarshalBinary(b []byte) error {
	var res SystemsV1SystemsComplianceRequest
