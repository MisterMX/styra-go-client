...
// V1ReplayStats v1 replay stats
//
// swagger:model v1.ReplayStats
type V1ReplayStats struct {
...
// Validate validates this v1 replay stats
func (m *V1ReplayStats) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ReplayStats) validateAnalysisErrors(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateBatchesAnalyzed(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateBatchesDownloadErrors(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateBatchesDownloaded(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateBatchesFromCache(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateBatchesObserved(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateBatchesScheduled(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateBatchesSkipped(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateEntriesEvaluated(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateEntriesFailed(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateEntriesObserved(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateEntriesScheduled(formats strfmt.Registry) error {
...
func (m *V1ReplayStats) validateResultsChanged(formats strfmt.Registry) error {
...
// ContextValidate validates this v1 replay stats based on context it is used
func (m *V1ReplayStats) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *V1ReplayStats) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1ReplayStats) UnmarshalBinary(b []byte) error {
	var res V1ReplayStats
