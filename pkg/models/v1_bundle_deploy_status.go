...
// V1BundleDeployStatus v1 bundle deploy status
//
// swagger:model v1.BundleDeployStatus
type V1BundleDeployStatus struct {
...
func (m *V1BundleDeployStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BundleDeployStatus) validateBuildErrors(formats strfmt.Registry) error {
...
// ContextValidate validate this v1 bundle deploy status based on the context it is used
func (m *V1BundleDeployStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1BundleDeployStatus) contextValidatePrimary(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1BundleDeployStatus) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BundleDeployStatus) UnmarshalBinary(b []byte) error {
	var res V1BundleDeployStatus
