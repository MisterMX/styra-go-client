...
//
// swagger:model datasources.Git.Blame
type DatasourcesGitBlame struct {
...
func (m *DatasourcesGitBlame) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m DatasourcesGitBlame) MarshalJSON() ([]byte, error) {
...
// Validate validates this datasources git blame
func (m *DatasourcesGitBlame) Validate(formats strfmt.Registry) error {
	var res []error
...
// ContextValidate validate this datasources git blame based on the context it is used
func (m *DatasourcesGitBlame) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DatasourcesGitBlame) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DatasourcesGitBlame) UnmarshalBinary(b []byte) error {
	var res DatasourcesGitBlame
