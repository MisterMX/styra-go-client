...
// V1SystemsPostRequest v1 systems post request
//
// swagger:model v1.SystemsPostRequest
type V1SystemsPostRequest struct {
...
// Validate validates this v1 systems post request
func (m *V1SystemsPostRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SystemsPostRequest) validateBundleRegistry(formats strfmt.Registry) error {
...
func (m *V1SystemsPostRequest) validateDecisionMappings(formats strfmt.Registry) error {
...
func (m *V1SystemsPostRequest) validateDeploymentParameters(formats strfmt.Registry) error {
...
func (m *V1SystemsPostRequest) validateName(formats strfmt.Registry) error {
...
func (m *V1SystemsPostRequest) validateSourceControl(formats strfmt.Registry) error {
...
func (m *V1SystemsPostRequest) validateType(formats strfmt.Registry) error {
...
// ContextValidate validate this v1 systems post request based on the context it is used
func (m *V1SystemsPostRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1SystemsPostRequest) contextValidateBundleRegistry(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SystemsPostRequest) contextValidateDecisionMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SystemsPostRequest) contextValidateDeploymentParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SystemsPostRequest) contextValidateSourceControl(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SystemsPostRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SystemsPostRequest) UnmarshalBinary(b []byte) error {
	var res V1SystemsPostRequest
