...
// V2TenantDetails v2 tenant details
//
// swagger:model v2.TenantDetails
type V2TenantDetails struct {
...
// Validate validates this v2 tenant details
func (m *V2TenantDetails) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V2TenantDetails) validateClaims(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateExternalServices(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateFeatures(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateID(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateName(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateOrgName(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateRemoved(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateRootUsers(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateSignupEmail(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateTackleInfo(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateTrialStartTime(formats strfmt.Registry) error {
...
func (m *V2TenantDetails) validateTrialStarted(formats strfmt.Registry) error {
...
// ContextValidate validate this v2 tenant details based on the context it is used
func (m *V2TenantDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V2TenantDetails) contextValidateExternalServices(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V2TenantDetails) contextValidateRootUsers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V2TenantDetails) contextValidateTackleInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V2TenantDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V2TenantDetails) UnmarshalBinary(b []byte) error {
	var res V2TenantDetails
