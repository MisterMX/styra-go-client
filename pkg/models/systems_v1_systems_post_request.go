...
// SystemsV1SystemsPostRequest systems v1 systems post request
//
// swagger:model systems.v1.SystemsPostRequest
...
// Validate validates this systems v1 systems post request
func (m *SystemsV1SystemsPostRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SystemsV1SystemsPostRequest) validateBundleRegistry(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPostRequest) validateDecisionMappings(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPostRequest) validateDeploymentParameters(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPostRequest) validateName(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPostRequest) validateSourceControl(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPostRequest) validateType(formats strfmt.Registry) error {
...
// ContextValidate validate this systems v1 systems post request based on the context it is used
func (m *SystemsV1SystemsPostRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SystemsV1SystemsPostRequest) contextValidateBundleRegistry(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPostRequest) contextValidateDecisionMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPostRequest) contextValidateDeploymentParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPostRequest) contextValidateSourceControl(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPostRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SystemsV1SystemsPostRequest) UnmarshalBinary(b []byte) error {
	var res SystemsV1SystemsPostRequest
