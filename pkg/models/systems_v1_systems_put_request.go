...
// SystemsV1SystemsPutRequest systems v1 systems put request
//
// swagger:model systems.v1.SystemsPutRequest
...
// Validate validates this systems v1 systems put request
func (m *SystemsV1SystemsPutRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SystemsV1SystemsPutRequest) validateBundleRegistry(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPutRequest) validateDecisionMappings(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPutRequest) validateDeploymentParameters(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPutRequest) validateName(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPutRequest) validateSourceControl(formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPutRequest) validateType(formats strfmt.Registry) error {
...
// ContextValidate validate this systems v1 systems put request based on the context it is used
func (m *SystemsV1SystemsPutRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SystemsV1SystemsPutRequest) contextValidateBundleRegistry(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPutRequest) contextValidateDecisionMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPutRequest) contextValidateDeploymentParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPutRequest) contextValidateSourceControl(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemsV1SystemsPutRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SystemsV1SystemsPutRequest) UnmarshalBinary(b []byte) error {
	var res SystemsV1SystemsPutRequest
