...
//
// swagger:model v1.BundleDistributionS3Config
...
// Validate validates this v1 bundle distribution s3 config
func (m *V1BundleDistributionS3Config) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BundleDistributionS3Config) validateBucket(formats strfmt.Registry) error {
...
func (m *V1BundleDistributionS3Config) validateDiscoveryPath(formats strfmt.Registry) error {
...
func (m *V1BundleDistributionS3Config) validatePolicyPath(formats strfmt.Registry) error {
...
func (m *V1BundleDistributionS3Config) validateRegion(formats strfmt.Registry) error {
...
// ContextValidate validate this v1 bundle distribution s3 config based on the context it is used
func (m *V1BundleDistributionS3Config) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1BundleDistributionS3Config) contextValidateOpaCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1BundleDistributionS3Config) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BundleDistributionS3Config) UnmarshalBinary(b []byte) error {
	var res V1BundleDistributionS3Config
