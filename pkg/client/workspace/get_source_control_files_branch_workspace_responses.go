...
func (o *GetSourceControlFilesBranchWorkspaceOK) GetPayload() *models.V1GetFilesResponse {
	return o.Payload
}
...
func (o *GetSourceControlFilesBranchWorkspaceNotFound) GetPayload() *models.V1ErrorResponse {
	return o.Payload
}
