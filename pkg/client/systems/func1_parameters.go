...
// WithBody adds the body to the func1 params
func (o *Func1Params) WithBody(body *models.V1VerifyConfigRequest) *Func1Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the func1 params
func (o *Func1Params) SetBody(body *models.V1VerifyConfigRequest) {
	o.Body = body
}
