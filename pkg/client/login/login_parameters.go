...
type LoginParams struct {
	...
	/* ProviderID.
	   ...
	   Id of the Login Provider (usually the name)
	*/
	ProviderID string
...
// WithProviderID adds the providerID to the login params
func (o *LoginParams) WithProviderID(providerID string) *LoginParams {
	o.SetProviderID(providerID)
	return o
}

// SetProviderID adds the providerId to the login params
func (o *LoginParams) SetProviderID(providerID string) {
