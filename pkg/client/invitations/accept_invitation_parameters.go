...
// WithToken adds the token to the accept invitation params
func (o *AcceptInvitationParams) WithToken(token string) *AcceptInvitationParams {
	o.SetToken(token)
	return o
}

// SetToken adds the token to the accept invitation params
func (o *AcceptInvitationParams) SetToken(token string) {
	o.Token = token
}
