...
// WithDependencies adds the dependencies to the get policy params
func (o *GetPolicyParams) WithDependencies(dependencies *bool) *GetPolicyParams {
	o.SetDependencies(dependencies)
	return o
}

// SetDependencies adds the dependencies to the get policy params
func (o *GetPolicyParams) SetDependencies(dependencies *bool) {
	o.Dependencies = dependencies
}

// WithPolicy adds the policy to the get policy params
func (o *GetPolicyParams) WithPolicy(policy string) *GetPolicyParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the get policy params
func (o *GetPolicyParams) SetPolicy(policy string) {
	o.Policy = policy
}
...
func (o *GetPolicyParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Dependencies != nil {
		...
		// query param dependencies
		var qrDependencies bool

		if o.Dependencies != nil {
			qrDependencies = *o.Dependencies
		}
		qDependencies := swag.FormatBool(qrDependencies)
		if qDependencies != "" {

			if err := r.SetQueryParam("dependencies", qDependencies); err != nil {
				return err
			}
		}
	}
