...
// WithPolicy adds the policy to the delete policy params
func (o *DeletePolicyParams) WithPolicy(policy string) *DeletePolicyParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the delete policy params
func (o *DeletePolicyParams) SetPolicy(policy string) {
	o.Policy = policy
}
