...
// WithTokenID adds the tokenID to the get token params
func (o *GetTokenParams) WithTokenID(tokenID string) *GetTokenParams {
	o.SetTokenID(tokenID)
	return o
}

// SetTokenID adds the tokenId to the get token params
func (o *GetTokenParams) SetTokenID(tokenID string) {
	o.TokenID = tokenID
}
