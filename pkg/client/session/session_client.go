...
type ClientService interface {
	...
	WhoAmI(params *WhoAmIParams, opts ...ClientOption) (*WhoAmIOK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
  Logout deletes user s session
*/
...
/*
  WhoAmI returns authenticated users id
*/
func (a *Client) WhoAmI(params *WhoAmIParams, opts ...ClientOption) (*WhoAmIOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
