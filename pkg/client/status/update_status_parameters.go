...
func (o *UpdateStatusParams) WithBody(body models.StatusV1AgentStatus) *UpdateStatusParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update status params
func (o *UpdateStatusParams) SetBody(body models.StatusV1AgentStatus) {
	o.Body = body
}
